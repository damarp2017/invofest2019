...
Route::group(['prefix' => 'itcompetition'], function() {
    ...
    Route::get('gdc', function() {
        return view('umum.competition.gdc');
    })->name('itcompetition.gdc');
});
...
Route::get('/apiAbsensiWorkshop', 'EventController@apiAbsensiWorkshop');
Route::get('/apiAbsensiTalkshow', 'EventController@apiAbsensiTalkshow');
Route::get('/apiAbsensiSeminar', 'EventController@apiAbsensiSeminar');
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth','admin']], function() {
    ...
    Route::get('/gdc', 'AdminController@gdc');
    ...
    Route::get('/api/kompetisi/gdc', 'AdminController@apiGdc')->name('api.kompetisi.gdc');
