        ...
        <div id="beranda" class="page-header page-header-small">
            ...
            <div class="container">
                <div class="content-center">
                    <h2 class="title wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0s" >GRAPHIC DESIGN COMPETITION <br><span style="font-weight: 100;">COMPETITION</span></h2>
        ...
        <div class="section section-deskripsi">
            <div class="container">
                ...
                <p class="text-justify wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.75s">
                    Graphic Design Competition 2018 merupakan salah satu kategori IT Competition pada event INVOFEST 2018 (Informatics Vocational Festival 2018) yang diselenggarakan oleh Program Studi DIV Teknik Informatika Politeknik Harapan Bersama. Database Programming Competition 2018 adalah kompetisi database programming yang dapat diikuti oleh mahasiswa-mahasiswi diseluruh Indonesia. Peserta Database Programming Competition 2018 berlomba adu skill atau kemampuan yang dimiliki untuk memecahkan suatu permasalahan dengan menggunakan database programming.
                </p>
                <br/><br/>
