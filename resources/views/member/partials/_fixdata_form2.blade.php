...
<div class="form-group row">
    ...
    <div class="col-sm-6">
        <input id="jenis_lomba" type="text" class="form-control{{ $errors->has('jenis_lomba') ? ' is-invalid' : '' }}" name="jenis_lomba" value="{{ $user->jenis_lomba == 'dpc' ? 'DATABASE PROGRAMMING COMPETITION' : 'GRAPHIC DESIGN COMPETITION' }}" required readonly>
    </div>
</div>
<br />
